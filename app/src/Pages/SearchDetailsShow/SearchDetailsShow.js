...
<div className="calendar ml-5">
  <div className="flex mt-5">
    ...
    <p className="mr-10">Present % - <span className="text-green-500">90</span> </p>
    <p>Attended Days- 4</p>
    </div>
...
function Header({ currentMonth, onMonthChange }) {
  ...
  onClick={() => onMonthChange(currentMonth.setMonth(currentMonth.getMonth() - 1))}
>
  <ChevronLeftIcon className="h-5 w-5" />
</button>
      <h2 className="text-2xl font-bold">{currentMonth.toLocaleString('default', { month: 'long' })}</h2>
